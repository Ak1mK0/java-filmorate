...
3. **Films** - общая таблица с фильмами.
    ...
    - *film_release_date* - дата релиза фильма(в формате **YYYY-MM-DD**)
...
3. Для таблицы **Films** первичным ключом является поле *film_id*, являющееся внешним ключом для таблиц **Film_like** и
   **Film_Genres**.
   *film_rating* является внешним ключом для таблицы **Film_Rating**.
   Тип связи <ins>one-to-many<ins>.
4. Таблица **Film_Genres** имеет составной первичный ключ.
   *film_id* является внешним для таблицы **Films**,
   *genre_id* являющийся внешним для таблицы **Genres**
